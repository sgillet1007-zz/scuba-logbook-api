...
// @desc    Udate user details
// @route   PUT /api/v1/auth/user/details
// @access  Private
...
// @route   POST /api/v1/auth/user/pw/forgot
// @access  Public
exports.forgotPw = asyncHandler(async (req, res, next) => {
...
// @desc    Reset password
// @route   PUT /api/v1/auth/user/pw/reset/:resettoken
// @access  Public
